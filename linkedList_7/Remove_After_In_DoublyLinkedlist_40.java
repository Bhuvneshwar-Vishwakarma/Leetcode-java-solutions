...
public class Remove_After_In_DoublyLinkedlist_40 {
  ...
  public static class DoublyLinkedList {
    ...
    private Node removeAfterNode(Node refNode) {
    	Node frwd = refNode.next;
    	if(frwd.next == null) {// tail
    		refNode.next = null;
    		frwd.prev = null;
    		this.tail = refNode;
    	}else {
    		refNode.next = frwd.next;
    		frwd.next.prev = refNode;
    		
    		frwd.next = frwd.prev = null;
    	}
    	this.size--;
    	return frwd;
